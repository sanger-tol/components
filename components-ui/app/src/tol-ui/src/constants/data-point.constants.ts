...
export const BOARD_DIFF_LOGGED_IN_OUT_DIFFERENCE_WARNING_MESSAGE = "Table configuration is saved separately for logged-in and logged-out sessions. Changes made in one will not carry over to the other.";