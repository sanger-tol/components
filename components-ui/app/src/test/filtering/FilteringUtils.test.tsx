...
import { IZone } from "../../tol-ui/src/board/Utils";
...
describe("Testing getComponentsAbove function", () => {
  test("Returns correct values above", () => {
    const testCall1 = getComponentsAbove("id", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall2 = getComponentsAbove("id3", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall3 = getComponentsAbove("id5", [
      "id",
      "id2",
      "id3",
      "id4",
  ...
  test("Returns empty array if id not found", () => {
    const testCall1 = getComponentsAbove("id6", [
      "id",
      "id2",
      "id3",
      "id4",
...
describe("Testing getComponentsBelow function", () => {
  test("Returns correct values below", () => {
    const testCall1 = getComponentsBelow("id", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall2 = getComponentsBelow("id3", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall3 = getComponentsBelow(
      "id5",
      ["id", "id2", "id3", "id4", "id5"],
      -1,
    );
  ...
  test("Returns empty array if id not found", () => {
    const testCall1 = getComponentsBelow("id6", [
      "id",
      "id2",
      "id3",
      "id4",
...
describe("Testing filterHasUpdated function", () => {
  ...
  test("Returns true if incoming filter is different from existing filter", () => {
    const mockSetFilter = vitest.fn();
    const testCall1 = filterHasUpdated(
      mockSetFilter,
      { a: 1, b: 2 },
      { a: 1, b: 2 },
    );
    ...
    const testCall2 = filterHasUpdated(
      mockSetFilter,
      { a: 1, b: 2 },
      { a: 1, b: 3 },
    );
...
describe("Testing addValueBelow function", () => {
  test("Adds value below id correctly", () => {
    const testCall1 = addValueBelow("id", "value", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall2 = addValueBelow("id3", "value", [
      "id",
      "id2",
      "id3",
      "id4",
    ...
    const testCall3 = addValueBelow("id5", "value", [
      "id",
      "id2",
      "id3",
      "id4",
