...
const ColourBoxes = ({ title, colourClasses }: { title: string, colourClasses: string[] }) => (
...
function Colours() {
  ...
  const components = [
    ...
    {
      component: <ColourBoxes title="Greyscale" colourClasses={basicColourClasses} />,
      type: 'full'
    },
    {
      component: <ColourBoxes title="Spectrum" colourClasses={actualColourClasses} />,
      type: 'full'
    }
  ];
